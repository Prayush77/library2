...
class Main:
    ...
    # Frames
        ...
        self.iconLogout = Image.open('icons/logout.png').resize(icon_size, Image.LANCZOS)
...
class EditBook(Toplevel):
    def __init__(self, main_instance):
        ...
        heading = Label(self.topFrame, text='EditBook', font='arial 22 bold', fg='#003f8a', bg='white')
